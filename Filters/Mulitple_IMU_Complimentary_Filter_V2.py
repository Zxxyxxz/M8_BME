...
def animate(i):
    ...
    if sensor_890E_angle_acc_z and sensor_890E_angle_gyr_z and sensor_890E_angle_complimentary_z :
        ax1.plot(sensor_890E_angle_acc_z, label='ACC angle z')
        ax1.plot(sensor_890E_angle_gyr_z, label='gyr angle z')
        ax1.plot(sensor_890E_angle_complimentary_z, label='comp Z')
        ax1.set_title('Sensor 890E')
        ax1.legend()

    ax2.clear()
    if sensor_890E_acc_x and sensor_890E_acc_y :
        ax2.plot(sensor_7516_angle_acc_z, label='ACC angle z')
        ax2.plot(sensor_7516_angle_gyr_z, label='gyr angle z')
        ax2.plot(sensor_7516_angle_complimentary_z, label='comp Z')
        ax2.set_title('Sensor 7516 ')
        ax2.legend()
